                        ...
                        <div className="group relative block bg-black mt-12 w-1/4">
                            <a href="#">
                                ...
                                <a
                                    ...
                                    onClick={(e) => { 
                                        e.preventDefault(); 
                                        console.log("Botón de Autofahrt clicado"); // Verifica si se activa
                                        incrementCO2(3); 
                                    }}
                                >Hinzufügen</a>
                            </div>
                        ...
                        <div className="group relative block bg-black mt-12 w-1/4">
                            <a href="#">
                                ...
                                <a
                                    ...
                                    onClick={(e) => { 
                                        e.preventDefault(); 
                                        console.log("Botón de Flug clicado"); // Verifica si se activa
                                        incrementCO2(250); 
                                    }}
                                >Hinzufügen</a>
                            </div>
                        ...
                        <div className="group relative block bg-black mt-12 w-1/4">
                            <a href="#">
                                ...
                                <a
                                    ...
                                    onClick={(e) => { 
                                        e.preventDefault(); 
                                        console.log("Botón de Zugfahrt clicado"); // Verifica si se activa
                                        incrementCO2(0.40); 
                                    }}
                                >Hinzufügen</a>
                            </div>
                        ...
                        <div className="group relative block bg-black mt-12 w-1/4">
                            <a href="#">
                                ...
                                <div className="relative p-4 sm:p-6 lg:p-8">
                                    ...
                                    <div className="mt-32 sm:mt-48 lg:mt-64">
                                        <div className="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                                            ...
                                            reduziert den CO₂-Aussto – ein kleiner Schritt mit großer Wirkung auf die Umwelt.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a
                                    ...
                                    onClick={(e) => { 
                                        e.preventDefault(); 
                                        console.log("Botón de Schiffahrt clicado"); // Verifica si se activa
                                        incrementCO2(115); 
                                    }}
                                >Hinzufügen</a>
                            </div>
